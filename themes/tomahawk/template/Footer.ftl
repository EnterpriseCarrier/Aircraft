...
<div id="footer">
  <ul>
    <li>
      ${uiLabelMap.CommonCopyright} (c) 2018-${nowTimestamp?string("yyyy")}<br/>
      ${uiLabelMap.CommonPoweredBy} <a href="http://www.enterprisecarrier.com" target="_blank">Enterprise Carrier</a>
